...
<body>
    <div class="section">
        ...
        <form:form action="${pageContext.request.contextPath}/webmvc/author" method="get">
            <button type="submit" class="action-button">Author</button>
        </form:form>


        <form:form action="${pageContext.request.contextPath}/webmvc/publisher" method="get" id="publisherForm">
            <button type="submit" class="action-button">Publisher</button>
        </form:form>

        <form:form action="${pageContext.request.contextPath}/book/add" method="get" id="bookForm">
            <button type="submit" class="action-button">Book</button>
        </form:form>

        <form:form action="${pageContext.request.contextPath}/member/addMember" method="get" id="memberForm">
            <button type="submit" class="action-button">Member</button>
        </form:form>

        <form:form action="${pageContext.request.contextPath}/issue/add" method="get" id="issueBookForm">
